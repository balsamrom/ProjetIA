...
urlpatterns = [
    ...
    # Multimedia (Avis) CRUD (Volt Dashboard)
    path('pages/multimedia/', views.multimedia_list_volt, name='volt_multimedia_list'),
    path('pages/multimedia/new/', views.multimedia_create_volt, name='volt_multimedia_create'),
    path('pages/multimedia/<int:pk>/edit/', views.multimedia_update_volt, name='volt_multimedia_update'),
    path('pages/multimedia/<int:pk>/delete/', views.multimedia_delete_volt, name='volt_multimedia_delete'),
